...
export async function sendPasswordResetEmail(
  ...
  await sendEmail(
    to,
    "Réinitialisation du mot de passe - Kriliy Engin",
...
export async function sendNewEquipmentEmail(
  ...
  const rows = [
    { label: "Matériel", value: details.equipmentName },
    ...(details.category
      ? [{ label: "Catégorie", value: details.category }]
      : []),
  ...
  const subsections = [
    {
      title: "Équipement",
      rows: [
        { label: "Matériel", value: details.equipmentNames.join("<br>") },
    ...
    uniqueSuppliers.forEach((s) => {
      subsections.push({
        ...
        rows: [
          ...
          { label: "Téléphone", value: formatPhoneNumber(s.phone) },
        ],
      })
    })
  }
  ...
  const subsections = [
    {
      title: "Réservation",
      rows: [
        { label: "Équipement", value: details.equipmentNames.join("<br>") },
        { label: "Fin prévue", value: formatDateTime(details.endDate) },
  ...
  details.suppliers.forEach((supplier) => {
    subsections.push({
      ...
      rows: [
        ...
        { label: "Téléphone", value: formatPhoneNumber(supplier.phone) },
      ],
    })
  })
  ...
  const subsections = [
    {
      ...
      rows: [
        { label: "Équipement", value: details.equipmentNames.join("<br>") },
        { label: "Début", value: formatDateTime(details.startDate) },
...
export async function sendPricingUpdateRequestEmail(
  ...
  const content = `
    ...
    ${createUnifiedSection("Détails", [
      {
        title: "Équipement",
        rows: [{ label: "Matériel", value: details.equipmentName }],
      },
      {
        title: "Partenaire",
        rows: [
  ...
  await sendEmail(
    ...
    "Demande de mise à jour tarifaire",
    content,
    "Examiner la demande",
